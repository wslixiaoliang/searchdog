    ...
    {
        searchKeyword = $("#searchKeyword").val();<!--获取搜索关键词-->
        $.ajax({
            type: "post",
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        str += '<div class="proDiv"'+i+' style="width:1000px;height:170px;color: #666666;margin-left:230px">' +
                                        ...
                                        '<div class='+z+' style="width:600px;height:150px;float:left;color:#666;margin-top:20px">' +
                                            '<a class='+a+' href="production.html?productionId='+productionId+'&searchKeyword='+searchKeyword+'" style="text-decoration:none;color:#666666;font-size:16px;font-family:\'微软雅黑\'" onmouseover="this.style.color=\'black\'" onmouseout="this.style.color=\'#666666\'" onmousedown="this.style.color=\'#666666\'">'+list[i].summaryInfo+'</a>' +
                                        '</div>' +
                              '</div>';
                        }
