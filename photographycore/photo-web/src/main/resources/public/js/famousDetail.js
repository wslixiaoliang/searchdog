        ...
        success: function (result) {
            ...
            if (result && result.beans){
                ...
                for (var i=0;i<list.length ;i++){
                    ...
                    detailDiv.setAttribute("style", "width: 600px;height: auto; margin: auto;margin-top:40px;text-align: center;align: center;")
                    ...
                    chineseName.setAttribute("style", "font-family: \"Microsoft YaHei\";font-size: 14px;");
                    ...
                    achievement.innerText = list[i].achievement;
